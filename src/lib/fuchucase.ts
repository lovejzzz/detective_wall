...
const spec: DemoSpec = {
  ...
  notes: [
    ...
    { key: "stop", type: "fact", title: "A \"police motorcycle\" pulls them over", when: "1968-12-10T09:21", approx: true, beat: "origin", url: JA_WIKI, body: "On the road along Fuchū Prison's north wall, a white police bike dragging a green car cover blocked the Cedric. The rider, in a white helmet and black leather jacket, said the manager's house had been bombed and this car might hold dynamite too." },
    ...
    { key: "montage", type: "fact", title: "The montage face goes public", when: "1968-12-21", url: JIJI, body: "Police released a \"montage\" of a young man in a white helmet that became the face of the case. It was not a composite: it was the untouched photo of an unrelated man, chosen for resembling Boy S." },

    // ── Hiratsuka's review ──
    { key: "hiratsuka", type: "fact", title: "Inspector Hiratsuka takes over the review", when: "1969-04", approx: true, url: NHK, body: "Veteran inspector Hachibei Hiratsuka joined four months in to re-examine the case. A note of his found by NHK reads: the stumble of the first investigation is not easily recovered." },
    ...
    { key: "wrongMan", type: "fact", title: "Named, arrested, cleared: the wrong man", when: "1969-12-12", beat: "dead_end", url: EN_WIKI, body: "After a newspaper scoop, police arrested a Fuchū driver in his twenties on an unrelated charge and the press printed his name and photo. An alibi cleared him within a day; the bar association later called the arrest illegal." },
    ...
    { key: "scrap", type: "fact", title: "Exhibit: a 4 mm scrap of newspaper", url: JA_WIKI, body: "Masking paper under the megaphone's paint matched page 11 of the Sankei for 6 December 1968, delivered to 13,485 homes in the Tama area. The match took two years; the delivery lists were gone." },
    ...
    { key: "serials", type: "fact", title: "Exhibit: 2,000 ¥500 notes, never seen again", url: JA_WIKI, body: "Only ¥1 million of the cash had recorded serials, XF227001A to XF229000A. Police published them; none has ever been confirmed as spent." },
