...
export const FUCHU_SPEC: DemoSpec = {
  ...
  notes: [
    ...
    { key: "unsub", type: "subject", title: "UNSUB: the motorcycle policeman", body: "Local, about 30, alone on the day.", url: "https://www.dailyshincho.jp/article/2024/12081103/?all=1", subject: { status: ["unidentified"], rank: 1, verdict: "The mainstream view (Hiratsuka): one local man about 30, alone; never named.", profile: ["Alone on the day: car to bike to cash car to car.", "Knew the Tama area's back lanes, ruins and car parks.", "A skilled thief of cars and motorbikes (four in a month).", "Knew the bank car, its route and its timing.", "Handy with tools and simple electrics.", "Probably close to 30; the letter-writer's blood type was B."] } },
    ...
    { key: "sShirata", type: "subject", title: "“Shirata”: a 2018 confession", body: "An anonymous online author; the book it became says it's fiction.", url: "https://www.j-cast.com/2018/10/02340064.html?p=all", subject: { status: ["unidentified"], rank: 2, verdict: "An anonymous 2018 confession; showed none of the numbered notes, key facts wrong.", for: ["Gets some obscure details right, readers noted."], against: ["Produced none of the ¥500 notes with published serials.", "A reporter who knew S's circle says key details are wrong."], settle: "One ¥500 note from XF227001A–XF229000A." } },
  ...
  links: [
    ...
    { from: "threeMinutes", to: "flare", relation: "references", reason: "The trick, step by step" },
