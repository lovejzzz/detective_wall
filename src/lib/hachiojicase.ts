...
const spec: DemoSpec = {
  ...
  notes: [
    ...
    { key: "areaMap", type: "diagram", title: "The neighbourhood, 30 July 1995", body: "Sketch, not to scale; north is up. The dashed line is the white car seen after 21:20.", diagram: { kind: "map", items: [
      { label: "Nanpei Ōwada store", x: 50, y: 42, mark: "scene", value: 1 },
      { label: "Kitanohara Park: bon-odori", x: 24, y: 14, w: 22, h: 14 },
      { label: "Crossing: car runs stop", x: 40, y: 58, mark: "place", value: 2 },
      { label: "Heading west", x: 14, y: 62, mark: "end", value: 3 },
      { label: "Kita-Hachiōji Stn, 750 m", x: 82, y: 22, mark: "place" },
      { label: "JR Hachiōji Stn, 2 km", x: 22, y: 90, mark: "place" },
      { label: "Hachiōji Bypass (Rte 16)", x: 8, y: 20, w: 5, h: 70 },
      { label: "Route 20", x: 30, y: 80, w: 62, h: 4 },
    ] } },
    ...
    { key: "officeMap", type: "diagram", title: "The office, as found", body: "Sketch from press accounts, not to scale. Footprints ran only along the line from the door to the safe and the victims.", diagram: { kind: "map", items: [
      { label: "Outside stairs, car park", x: 10, y: 88, mark: "start", value: 1 },
      { label: "Door", x: 14, y: 62, mark: "place", value: 2 },
      { label: "Counter", x: 22, y: 38, w: 8, h: 34 },
      { label: "Two girls, taped", x: 52, y: 52, mark: "scene", value: 3 },
      { label: "Safe: key in, bullet mark", x: 78, y: 26, mark: "scene", value: 4 },
      { label: "Inagaki, by the safe", x: 76, y: 62, mark: "scene" },
      { label: "Desk: bullet beneath", x: 44, y: 16, w: 18, h: 8 },
      { label: "Office, upstairs", x: 8, y: 8, w: 82, h: 72 },
    ] } },
