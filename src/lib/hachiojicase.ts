...
export const HACHIOJI_VERSION = 4;
...
export const HACHIOJI_SPEC: DemoSpec = {
  ...
  notes: [
    ...
    { key: "unsub", type: "subject", title: "UNSUB: the gunman in the office", body: "One man inside; whether anyone waited outside is unknown.", url: MAINICHI, subject: { status: ["unidentified"], rank: 1, verdict: "One gunman in a robbery that fell apart (the police's main line); prints unmatched.", profile: ["Alone inside: one set of 26 cm sneaker prints, about ten of them.", "Had a .38 Philippine-made revolver and fired it at point-blank range.", "Brought or found packing tape and bound two women in seconds.", "Iron filings, clay and moss on his soles: a works, or scrub nearby.", "Struck on the sale's last Sunday, with ¥5.26m in the safe.", "Left in about two minutes, taking no cash, wallets or valuables."] } },
    { key: "sMotomura", type: "subject", title: "“Motomura”, a robbery-gang figure", body: "An alias traced around 2010; the man behind it has never been identified.", url: TOKYO_NP, subject: { status: ["unidentified"], rank: 2, verdict: "Inmates say the alias claimed the job; all second-hand, nothing physical ties it.", for: ["A Japanese inmate said a man using the name told him he did the job.", "Described as leading a Tokyo gang that used guns and tape.", "An associate reportedly said the gunman was shocked to find three staff."], against: ["Every account is second-hand, from prisoners.", "One source was on death row and may have traded stories for time.", "No physical evidence ties the alias to the office."], settle: "Identify the man behind the alias and test his prints and DNA against the tape and the seven unknown prints." } },
    { key: "sCanada", type: "subject", title: "A Fujian man extradited from Canada", body: "Brought to Japan in 2013 on a passport charge; never charged over the killings.", url: MAINICHI, subject: { status: ["never charged"], rank: 3, verdict: "Said to know who the gunman was; police found nothing linking him to the office.", for: ["Named by the Dalian informant as knowing who the gunman was.", "A trial witness called him an informant for a robbery gang.", "Said to have lived in the Tokyo area in 1995."], against: ["Denied any role and said he knew no gunman.", "Police got nothing linking him to the case.", "Convicted only of passport fraud; back in Canada since 2014."], settle: "A named gunman from his circle whose prints or DNA match the office evidence." } },
