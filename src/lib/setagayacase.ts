...
export const SETAGAYA_VERSION = 4;
...
export const SETAGAYA_SPEC: DemoSpec = {
  ...
  notes: [
    ...
    { key: "unsub", type: "subject", title: "UNSUB: the intruder of 30 December", body: "One man, hand injured, who stayed for hours.", url: MPD_PDF, subject: { status: ["unidentified"], rank: 1, verdict: "One man, blood type A, on no Japanese file: the police's view and the evidence's.", profile: ["Male, blood type A; cut a hand during the attack.", "About 170 cm and slim: waist 70–75 cm from the 83 cm belt.", "Probably right-handed; wore Slazenger shoes, size 27.5.", "Prints and DNA unmatched in Japan: no criminal record on file.", "Age: 15 to 20s from his clothes (2018); 30s by DNA (2025 report).", "Could climb to a window 3.4 m up, police said in 2024."] } },
