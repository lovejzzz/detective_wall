...
const spec: DemoSpec = {
  ...
  notes: [
    ...
    { key: "mapRoute", type: "diagram", title: "Sixteen days across Seoul", body: "Sketch, not to scale; north is up. The drops and calls, 29 January to 19 February 1991, and the drain found on 13 March.", diagram: { kind: "map", items: [
      { label: "Han River", x: 48, y: 50, w: 84, h: 7 },
      { label: "Apgujeong: the playground", x: 62, y: 60, mark: "start", value: 1 },
      { label: "Gimpo: lot 2", x: 10, y: 46, mark: "place", value: 2 },
      { label: "Daehan Cinema, Chungmuro", x: 50, y: 30, mark: "place", value: 3 },
      { label: "Kyobo, Gwanghwamun", x: 40, y: 22, mark: "place", value: 4 },
      { label: "Taegeukdang: first memo", x: 58, y: 34, mark: "place", value: 5 },
      { label: "Bridge memo, Olympic Expwy", x: 36, y: 58, mark: "place", value: 6 },
      { label: "Yanghwa: the bag taken", x: 24, y: 56, mark: "scene", value: 7 },
      { label: "Sanggye-dong bank", x: 76, y: 12, mark: "place", value: 8 },
      { label: "Jamsil drain", x: 82, y: 58, mark: "end" },
    ] } },
    { key: "mapYanghwa", type: "diagram", title: "The Yanghwa drop, 13 Feb 1991", body: "Sketch, not to scale; north is up. The bag went on the switchboard beside the expressway; the detectives watched a bench about 20 m toward the river.", diagram: { kind: "map", items: [
      { label: "Riverside park", x: 58, y: 20, w: 56, h: 14 },
      { label: "Olympic Expressway", x: 52, y: 48, w: 76, h: 10 },
      { label: "Yanghwa Bridge", x: 22, y: 42, w: 10, h: 60 },
      { label: "Switchboard: the bag", x: 36, y: 58, mark: "scene", value: 1 },
      { label: "Taken from a passing car?", x: 66, y: 46, mark: "end", value: 2 },
      { label: "Bench the police watched", x: 44, y: 32, mark: "place" },
    ] } },
    ...
    { key: "callsFlow", type: "diagram", title: "Sixteen days of calls", diagram: { kind: "flow", items: [
      { label: "29 Jan: first call" },
      { label: "31 Jan: Gimpo, Chungmuro" },
      { label: "1 Feb: Kyobo" },
      { label: "5 Feb: the memos" },
      { label: "13 Feb: Yanghwa" },
      { label: "14 Feb: last call" },
  ...
  links: [
    ...
    { from: "mapRoute", to: "kidnap", relation: "references", reason: "The whole route" },
