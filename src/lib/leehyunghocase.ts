...
export const LEEHYUNGHO_VERSION = 4;
...
export const LEEHYUNGHO_SPEC: DemoSpec = {
  ...
  notes: [
    ...
    { key: "unsub", type: "subject", title: "UNSUB: the voice on the phone", body: "The man who made the calls; possibly not the man who planned them.", url: HYUNDAE, subject: { status: ["unidentified"], rank: 1, verdict: "The caller, likely with a driver and a grabber (1991 task force, SBS); unidentified.", profile: ["Man, late 20s to early 30s, Seoul–Gyeonggi speech (NFS analysis).", "Calm and formal, polite even when angry; educated past high school.", "Used jargon like 도킹 (docking); clear English pronunciation.", "Knew of an elder brother, not that the mother was a stepmother.", "Moved between payphones in Seoul and Gwangmyeong, calls under 4 min.", "Planned drops needing a car: likely a driver and a grabber."] } },
    { key: "sRelative", type: "subject", title: "A maternal relative, 29", body: "Questioned in March 1991 after the NFS judged his voiceprint a match. Never charged.", url: JOONGANG_1991, subject: { status: ["never charged"], rank: 3, verdict: "Voiceprint judged a match, but his Gyeongju alibi held; released without charge.", for: ["NFS voiceprint judged a match (police: 1-in-100,000 error).", "Short of money after a business failure (JoongAng, 1991)."], against: ["In Gyeongju on 31 Jan, the day of 16 calls from Seoul and nearby.", "Inn staff confirmed his stay in a face-to-face check.", "No physical evidence; released without charge."], settle: "His voice today against the NFS's 1991 recordings, with modern speaker analysis and a relay-call alibi test." } },
    ...
    { key: "sBank", type: "subject", title: "The man at the Sanggye-dong bank", body: "Tried to withdraw ₩7 million on 19 February 1991 and fled with the passbook. The montage came from bank staff.", url: HANKOOK_1991, subject: { status: ["unidentified"], rank: 2, verdict: "Knew the account and fled at the counter: one of the team, or the caller himself.", for: ["Knew the account and phoned first to check the deposit.", "Fled the moment the clerk refused, taking the passbook."], against: ["Could have been a courier, not the caller himself.", "280,000 montage leaflets never produced a name."], settle: "DNA from the account forms and memos, if police still hold them, against a candidate." } },
