...
const spec: DemoSpec = {
  ...
  notes: [
    ...
    { key: "unsub", type: "subject", title: "UNSUB: whoever killed the five", body: "Never identified. Inferred from the skulls and the grave.", url: JOONGANG_KNU, subject: { status: ["unidentified"], profile: ["Struck again and again: 25 marks on one skull, ~10 on two (KNU).", "Used a narrow-edged tool (~2 mm) as well as blunt force; no gun.", "Killed them near the gully, probably the day they vanished (KNU).", "Hid them under stones and earth in a deep, overgrown gully.", "Knew a hidden gully by the army range, off the searched paths.", "Overpowered five boys aged 9–13; KNU thought two or more."] } },
