...
// charged with the poisonings, which he denied. Roger Arnold appears as the record has him: questioned
// and cleared of the poisonings. The Idaho identification is reported as the sheriff reported it,
...
const spec: DemoSpec = {
  ...
  notes: [
    ...
    { key: "janus", type: "fact", title: "Three of the Janus family", when: "1982-09-29T15:15", url: CBS, body: "Adam Janus, 27, a postal worker, collapsed at home in Arlington Heights and was pronounced dead at Northwest Community Hospital at 3:15 p.m. That afternoon his brother Stanley, 25, and Stanley's wife Theresa took capsules from the same bottle. Stanley died at 8:15 p.m., Theresa on 1 October." },
    { key: "pArl", type: "photo", photo: C.arlington, title: "Arlington Heights, Illinois", body: "Where Adam Janus lived; his family gathered at his house that afternoon." },
    ...
    { key: "princeBuys", type: "fact", title: "Paula Prince buys her bottle", when: "1982-09-29T21:16", url: TRIB_BOTTLES, body: "Still in uniform after landing at O'Hare, the United flight attendant, 35, bought 24 Extra-Strength capsules at the Walgreens at 1601 N. Wells St. The store camera caught her at the register." },
    { key: "pOld", type: "photo", photo: C.oldTown, title: "Old Town, Wells Street", body: "Her Walgreens stood at 1601 North Wells." },
    { key: "pOhare", type: "photo", photo: C.ohare, title: "O'Hare", body: "Prince had worked a Las Vegas round trip and then an out-and-back to Hartford before landing here." },
    { key: "marys", type: "fact", title: "Mary Reiner and Mary McFarland", when: "1982-09-30T09:03", url: CBS, body: "Mary McFarland, 31, of Elmhurst collapsed at work in Yorktown Center, Lombard, on the evening of the 29th and died at 3:15 a.m. Mary \"Lynn\" Reiner, 27, of Winfield, a week after giving birth, died at Central DuPage Hospital at 9:03 a.m." },
    ...
    { key: "pCyanide", type: "photo", photo: C.cyanide, title: "Potassium cyanide", body: "A lethal dose beside a one-cent coin: the poison in the capsules." },
    ...
    { key: "prince", type: "fact", title: "Paula Prince, the seventh", when: "1982-10-01T17:45", approx: true, url: CBS, body: "Her sister found her in her Old Town condo. One capsule was gone from the bottle; four of the 23 left held cyanide." },
    { key: "reward", type: "fact", title: "$100,000 reward, 100 agents", when: "1982-10-01", url: "https://www.upi.com/Archives/1982/10/02/Flight-attendant-Paula-Prince-Saturday-became-the-seventh-victim/2195402379200/", body: "Johnson & Johnson's McNeil offered $100,000 for the poisoner. A task force under Illinois Attorney General Tyrone Fahner grew past 100 agents and took 300–400 tips a day." },

    // ── Recall, a letter, an arrest ──
    { key: "recall", type: "fact", title: "The recall", when: "1982-10-05", beat: "escalation", url: UPI_LOTS, body: "After recalling two lots (264,000 bottles) on 30 September and 1 October, J&J pulled every Tylenol capsule in the country: about 31 million bottles worth over $100 million. Tylenol's market share fell from 35% to 8%." },
    ...
    { key: "letter", type: "fact", title: "\"$1 million to stop the killing\"", when: "1982-10-06", url: "https://www.upi.com/Archives/1983/10/19/The-text-of-the-extortion-letter-James-Lewis-allegedly/6333435384000/", body: "A handwritten letter mailed on 1 October reached McNeil: \"If you want to stop the killing then wire $1,000,000 to bank account number 84-49-597 at Continental Illinois Bank Chicago.\" The account belonged to a travel agency that had bounced a paycheck of LeAnn Lewis's." },
    { key: "arnold", type: "fact", title: "Roger Arnold picked up", when: "1982-10-11", url: "https://www.upi.com/Archives/1982/10/13/Police-acting-on-a-tip-received-during-the-investigation/6229403329600/", body: "On a bar owner's tip, police questioned Jewel dockhand Roger Arnold, 48, who admitted buying cyanide earlier that year. They found guns but no cyanide; he was charged only with weapons violations and cleared of the poisonings." },
    ...
    { key: "eight", type: "fact", title: "Eight poisoned bottles in all", when: "1982-10-25", url: TRIB_BOTTLES, body: "Testing returned stock found a seventh bottle, from a Dominick's in Old Town (11 of 50 capsules), and an eighth, bought at Frank's Finer Foods in Wheaton (7 of 50). Five bottles killed seven people; three never did." },
    ...
    { key: "pSealed", type: "photo", photo: C.sealed, title: "An induction-sealed bottle", body: "The foil seal under the cap, standard on medicine since 1982." },
    ...
    { key: "pBoise", type: "photo", photo: C.boise, title: "Boise's Union Pacific depot", body: "The sheriff thinks he arrived by rail and walked to the church." },
    { key: "lewis", type: "fact", title: "Extortion, not murder", when: "1982-12-13", url: "https://www.nytimes.com/1983/10/28/us/jurors-convict-suspect-in-1-million-tylenol-extortion-plot.html", body: "The FBI arrested James W. Lewis in a New York Public Library reading room. He was convicted of attempted extortion on 27 October 1983, sentenced to 10 years on top of a mail-fraud term, and released in 1995. He was never charged with the murders, which he denied." },

    // ── Years without a charge ──
    { key: "stanisha", type: "fact", title: "Arnold kills a man in a bar", when: "1983-06-18", url: TRIB_TIMELINE, body: "Roger Arnold shot and killed John Stanisha, 46, mistaking him for the bartender who had named him to police. He served 15 years of a 30-year term." },
    ...
    { key: "elsroth", type: "fact", title: "1986: it happens again", when: "1986-02-08", beat: "twist", url: "https://www.upi.com/Archives/1986/02/23/A-chronology-of-the-events-surrounding-the-death-this/9188509518800/", body: "Diane Elsroth, 23, died in Yonkers, N.Y., after taking two cyanide-laced capsules from a triple-sealed box bought at a Bronxville A&P. On 17 February J&J stopped selling capsules altogether." },
    ...
    { key: "parole", type: "fact", title: "Parole board: Lewis \"responsible\"", when: "1989-08-23", url: TRIB_TIMELINE, body: "Denying him early release, the U.S. Parole Commission found by a preponderance of the evidence that Lewis \"was responsible for\" the deaths. It is the only official body ever to say so." },
    ...
    { key: "kaczynski", type: "fact", title: "The FBI asks the Unabomber for DNA", when: "2011-05-19", url: "https://www.reuters.com/article/world/us/fbi-seeks-dna-from-unabomber-for-tylenol-case-idUSTRE74I5GJ/", body: "The FBI said Ted Kaczynski had declined to give a sample voluntarily; he said he had never had potassium cyanide." },
    ...
    // ── A lead from Idaho ──
    { key: "idaho", type: "web", title: "Named after 43 years", when: "2026-09-23", beat: "latest", url: ABC_IDAHO, body: "Ada County identified the Boise man as Dr. Mathew Francis Betkouski, an organic chemist traced through an engraved key and his brother's DNA. Ex-colleagues recalled talk of poisoning capsules, but his desk held homemade sodium cyanide, not Chicago's potassium cyanide, and nothing places him in Chicago." },
    { key: "disputed", type: "web", title: "The Idaho lead is disputed", when: "2026-09-25", url: KIVI, body: "The FBI calls such claims unsubstantiated and Illinois State Police say they vetted the file years ago. The original prosecutor called it \"utter nonsense\"; Mary Reiner's daughter calls Betkouski a serious person of interest." },
    ...
    { key: "lots", type: "fact", title: "Bottles from two plants, eight stores", url: UPI_LOTS, body: "The poisoned bottles came from lots made in Fort Washington, Pa. (MC2880) and Round Rock, Texas (1910MD) and were sold at eight stores from Old Town to Wheaton, so the factory was ruled out early." },

    // ── Open questions ──
    { key: "who", type: "hypothesis", title: "Who could reach eight stores in two days?", body: "Eight bottles, eight stores from Old Town to Wheaton, bought 28–29 September." },
    { key: "connected", type: "hypothesis", title: "Is the Boise death connected?", color: "blue", body: "A chemist who talked of poisoned capsules, but a different cyanide, and nothing that puts him in Chicago." },
    { key: "compare", type: "hypothesis", title: "Test Betkouski's DNA against the bottles", color: "green", proposed: true, body: "His brother's DNA identified him; the same profile could be compared with the DNA from the three bottles." },
  ],
  links: [
    ...
    { from: "letter", to: "lewis", relation: "causes", reason: "The letter was traced to him" },
    ...
    { from: "compare", to: "dna", relation: "references", reason: "The profiles to compare", proposed: true },
  ],
  messages: [
    { role: "user", text: "The 1982 Chicago Tylenol murders: what happened, how did the case develop, and why is it still unsolved?" },
    {
      role: "assistant",
      text: "Between 29 September and 1 October 1982, seven people around Chicago died after taking Extra-Strength Tylenol capsules refilled with potassium cyanide, among them a 12-year-old girl and three members of one family. Eight poisoned bottles turned up in eight stores, from lots made in two different plants, so someone tampered with them on the shelves. J&J recalled about 31 million bottles, and the case gave the world tamper-evident packaging.\n\nThe only conviction was for extortion: James W. Lewis demanded $1 million by letter. He denied the poisonings, was never charged with them, and died in 2023; DNA from three bottles matched neither him nor Roger Arnold.\n\nThe newest turn is this week's: Idaho named a man who died of cyanide in a Boise church in December 1982, a chemist who talked of poisoned capsules. His cyanide was a different kind, nothing places him in Chicago, and the FBI and the original prosecutor reject the link.\n\nNext lead: compare Betkouski's DNA with the bottles.\nNext lead: the bearded man in the Walgreens film.",
